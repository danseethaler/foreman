...
describe('Chart', () => {
  describe('has no data', () => {
    it('renders MessageBox with noDataMsg property', () => {
      ...
      const chart = shallow(<Chart config={config} noDataMsg="No data here" />);
    ...
    */
    ...
    describe('sets title when appropriate', () => {
      it('calls setTitle if present', () => {
        ...
        mount(<Chart id="operatingsystem" setTitle={setTitle} config={config} />);
    ...
    describe('life cycle events', () => {
      it('update', () => {
        const chart = mount(<Chart id="operatingsystem" config={config} />);
