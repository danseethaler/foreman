...
var webpackedDirs = () =>
  execSync(path.join(__dirname, './plugin_webpack_directories.rb'), {
    stdio: ['pipe', 'pipe', 'ignore'],
  });

var getPluginDirs = () => JSON.parse(sanitizeWebpackDirs(webpackedDirs()));

var packageJsonDirs = () => pluginPath('package.json')(getPluginDirs()).map(path.dirname);
